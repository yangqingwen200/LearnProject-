<template>
  <div id="articleDetail">
    ...
    <hr class="my-hr">
    <div id="articleAd" style="height: 100px">
      广告
    </div>
    <hr class="my-hr">
    <div id="articleRecommend" style="height: 200px">
      推荐列表
    </div>
    <hr class="my-hr">
    <div id="articleComment" style="margin-bottom: 3.7rem;height: 200px">
      热门评论
    </div>
    <div class="footer">
      ...
      <div style="vertical-align: middle;display: table-cell;">
        <button :class="{'my-button': 'my-button', 'my-button-ok': myButtonOk}" v-if="discussing">发表</button>
      </div>
    </div>
  </div>
</template>
